...
# This code is licensed by... uhmm... I don't know...
# ...under GPLv3, maybe.
		...
		for toParse in data.split(".\n"):
			...
			if len(dom.getElementsByTagName('INPUT')) >= 1:
				...
				if status == "LISTEN":
					...
					print "Fin de grabacion de voz"
			elif len(dom.getElementsByTagName('STARTRECOG')) >= 1:
				print "Comenzando reconocimiento de voz"
				...
				print "He recibido los comandos siguientes:", command
